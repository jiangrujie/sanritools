...
import com.sanri.file.xls.simple.PoiExcel2k3Helper;
import com.sanri.file.xls.simple.PoiExcel2k7Helper;
import com.sanri.file.xls.simple.PoiExcelHelper;
...
public abstract class PoiExcelTest {
	...
	public static void main(String[] args){
		// 获取Excel文件的sheet列表
		testGetSheetList("d:/test.xls");
		
		// 获取Excel文件的第1个sheet的内容
		testReadExcel("d:/test.xls", 0);
		
		// 获取Excel文件的第2个sheet的第2、4-7行和第10行及以后的内容
		testReadExcel("d:/test.xls", 0, "2,4-7,10-");
		
		// 获取Excel文件的第3个sheet中a,b,g,h,i,j等列的所有内容
		testReadExcel("d:/test.xls", 0, new String[] {"a","b","g","h","i","j"});
		
		// 获取Excel文件的第4个sheet的第2、4-7行和第10行及以后，a,b,g,h,i,j等列的内容
		testReadExcel("d:/test.xls", 0, "2,4-7,10-", new String[] {"a","b","g","h","i","j"});
	}
