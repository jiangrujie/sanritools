...
// * 
// * 作者:sanri</br>
// * 时间:2016-9-27下午5:07:35</br>
// * 功能:linux 连接 依赖包 jsch-0.1.53.jar,oro-2.0.8.jar,expect4j-1.6.jar<br/>
// */
//public class LinkLinux {
//
//    private static Logger log = Logger.getLogger(LinkLinux.class);
//    
...
//    
//    public LinkLinux(String ip,int port,String user,String password) {
//        this.ip=ip;
//        this.port=port;
//        this.user=user;
...
//    	int port = 22;
//    	String user ="root";
//    	String password = "h196944";
//    	String cmd[] = {"shutdown -h now","ifconfig"};
//    	LinkLinux ssh = new LinkLinux(ip,port,user,password);
